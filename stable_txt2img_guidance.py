...
def main():
    ...
    sin_model.cond_stage_model.device = device
    model.cond_stage_model.device = device
    K = 1000 - (opt.range_t_max - opt.range_t_min)
                ...
                with sin_model.ema_scope():
                    ...
                    if not opt.skip_grid:
                        ...
                        for i in range(grid.size(0)):
                            save_image(grid[i, :, :, :], os.path.join(outpath,opt.prompt+'_K={}_{}.png'.format(str(K).zfill(4),i)))
